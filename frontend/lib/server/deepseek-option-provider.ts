        ...
        messages: [
          {
            ...
            content: [
              ...
              "服务端会先根据模拟病历中的表达能力、肢体功能、饮水/进食状态、吞咽风险、体位限制和护理注意事项生成或替换候选项；你只能使用用户提供的候选 id，不得新增、删除或修改医疗意图。",
              ...
              "guidance 用一句不超过 50 个汉字的话，说明本轮如何根据已选需求和患者状态组织引导选项。",
              "不得声称读取了未提供的病历、检查或生命体征，也不得使用发生率、常见性或临床优先级作为排序依据。",
              "guidance 示例：已根据肢体失能状态，将进食和体位需求调整为护理协助入口。",
          ...
          },
          {
            ...
            content: JSON.stringify({
              ...
              clinicalContext: {
                ...
                motorFunction: input.patient.motorFunctionLabel,
